...
<section style="padding: 60px 20px;">
    <div class="container">
        ...
        <?php if (count($fonluk_products) > 1): ?>
        <!-- Search/Filter Bar -->
        ...
        <!-- Fonluk Tab Content -->
        <div class="tab-content" id="fonluk-content" >
            <div class="products-grid"
                style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 30px;">
                <?php foreach ($fonluk_products as $product): ?>
                    <div class="product-card" data-name="<?php echo strtolower($product['name']); ?>">
                        <div class="card-image" style="position: relative;">
                            <img src="assets/images/products/fonluk/thumbnails/<?php echo strtolower($product['name']); ?>.webp"
                        ...
                        <div class="card-content">
                            ...
                            <div style="display: flex; gap: 10px;">
                                <a href="assets/products/fonluk/pdfs/<?php echo $product['name']; ?>.pdf"
