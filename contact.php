        ...
        <div class="grid-2" style="gap: 50px; align-items: start;">
            ...
            <div>
                <div class="section-header" style="text-align: left; margin-bottom: 30px;">
                    ...
                    <p>Fill out the form below and we'll contact you within 24 hours to schedule your free in-home
                        consultation.</p>
                </div>

                <!-- Success/Error Messages -->
                <div id="formMessage" style="display: none; padding: 15px; border-radius: 4px; margin-bottom: 20px;">
                </div>
                ...
                <form id="contactForm" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="message" name="message"
                            placeholder="Tell us about your project, preferred schedule, style preferences, etc."></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <label style="display: flex; align-items: start; gap: 10px; cursor: pointer;">
                            ...
                            <span style="font-size: 0.9rem; color: var(--text-gray);">I agree to receive communication
                                from <?php echo SITE_NAME; ?> regarding my inquiry. *</span>
                        </label>
                    </div>
                    ...
                    <p style="font-size: 0.85rem; color: var(--text-gray); margin-top: 15px; text-align: center;">
                        ...
                        <a href="https://policies.google.com/privacy" target="_blank"
                            style="color: var(--primary-teal);">Privacy Policy</a> and
                        <a href="https://policies.google.com/terms" target="_blank"
                            style="color: var(--primary-teal);">Terms of Service</a> apply.
                    </p>
                </form>
            </div>
            ...
            <div>
                <div style="margin-bottom: 30px;">
                    ...
                    <p style="color: var(--text-gray); margin-bottom: 20px;">See our products in person! Browse hundreds
                        of fabric samples, blinds, shutters, and more at our Aurora showroom.</p>

                    <!-- Google Map Embed -->
                    <div
                        style="border-radius: 8px; overflow: hidden; box-shadow: 0 2px 15px rgba(0,0,0,0.1); margin-bottom: 25px;">
                        <iframe
                    ...
                    <div style="background: var(--warm-cream); padding: 25px; border-radius: 8px;">
                        ...
                        <p style="margin-top: 15px; font-size: 0.9rem; color: var(--text-gray);">
                            <strong>Note:</strong> In-home consultations available by appointment, including evenings
                            and weekends!
                        </p>
                    </div>
                </div>
...
<section style="padding: 60px 20px; background-color: var(--warm-cream);">
    <div class="container">
        <div class="grid-3">
            <!-- Phone -->
            <div
                style="background: white; padding: 30px; border-radius: 8px; text-align: center; box-shadow: 0 2px 15px rgba(0,0,0,0.08);">
                <div
                    style="width: 70px; height: 70px; margin: 0 auto 20px; background: var(--warm-cream); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 2rem;">
                    📞
                </div>
                ...
                <a href="tel:<?php echo str_replace(['(', ')', ' ', '-'], '', BUSINESS_PHONE); ?>"
                    onclick="dataLayer.push({'event': 'phone_click'});"
                    style="color: var(--primary-teal); font-size: 1.3rem; font-weight: 600;"><?php echo BUSINESS_PHONE; ?></a>
            </div>
            ...
            <div
                ...
                <a href="mailto:<?php echo BUSINESS_EMAIL; ?>"
                    style="color: var(--primary-teal); font-size: 1.1rem; font-weight: 600; word-break: break-word;"><?php echo BUSINESS_EMAIL; ?></a>
            </div>
            ...
            <div
                ...
                <a href="https://www.google.com/maps/dir/?api=1&destination=850+S+Frontenac+Street+Aurora+IL+60505"
                    target="_blank" style="color: var(--primary-teal); font-weight: 600;">Get Directions →</a>
            </div>
        </div>
    </div>
</section>
